...
const socials = [
    {
        name: "LinkedIn",
        buildSVG({ width = "13", height = "14", fill = "none" }) {
    ...
    {
        name: "Twiter",
        buildSVG({ width = "17", height = "14", fill = "none" }) {
            return (
                <svg width={width} height={height} viewBox="0 0 17 14" fill={fill} xmlns="http://www.w3.org/2000/svg">
    ...
    {
        name: "Facebook",
        buildSVG({ width = "9", height = "17", fill = "none" }) {
            return (
    ...
    {
        name: "Pinterest",
        buildSVG({ width = "13", height = "16", fill = "none" }) {
            return (
                <svg width={width} height={height} viewBox="0 0 13 16" fill={fill} xmlns="http://www.w3.org/2000/svg">
        ...
        <StyledUl>
            {
                socials.map((item) => {
                    return (
                        <SocialLink key={item.name} social={item} />
                    )
                })
            }
        </StyledUl>
